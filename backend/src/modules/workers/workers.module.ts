...
import { FetcherRefreshWorker } from './fetcher-refresh.worker';
...
@Module({
  imports: [
    FetcherModule,    // provides FetcherService for FetcherRefreshWorker
  ...
  providers: [PostWorker, SentimentWorker, FetcherRefreshWorker],
})
